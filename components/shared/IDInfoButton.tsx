            ...
            >
                {view === ShowView.MENU && (
                    <Paper elevation={0} square sx={{ width: 196, maxWidth: "100%" }}>
                        <MenuList>
                            ...
                            >
                                <ListItemIcon>
                                    <Image alt="" layout="fixed" src={iconColors as string}
                                        width={20} height={20} />
                                </ListItemIcon>
                                <ListItemText
                                    slotProps={{
                                        primary: { sx: { fontSize: theme.typography.pxToRem(14) } },
                                    }}
                                >
                                    Farben und Icons
                                </ListItemText>
                            ...
                            <MenuItem
                                sx={{ px: theme.spacing(3) }}
                                component={Link}
                                href="https://confluence.ippen.io/x/ooM8Iw"
                                target="_blank"
                            >
                                <ListItemIcon>
                                    <FeedbackIcon />
                ...
                {view === ShowView.COLORS && (
                    ...
                    >
                        ...
                        {/* Footer */}
                        <IDInfoBoxFooter view={ShowView.DRAW} id={id} handleChangeView={handleChangeView}>
                ...
                {view === ShowView.DRAW && (
                    ...
                    >
                        ...
                        >
                            ...
                            &nbsp;Die <strong>Priorität</strong> der Ausspielung geht <strong>von Tag</strong>
                            über <strong>Kategorie</strong> zu <strong>Mandant</strong>.
                            Dabei wird mit <strong>Überschreiben</strong> und
                            &nbsp;<strong>Übernehmen</strong> gearbeitet.
                        </Typography>
                        ...
                        >
                            ...
                            &nbsp;auf einem <strong>Artikel</strong> speziell <strong>ausgespielt</strong>
                            &nbsp;wird, so muss man sich die <strong>gesetzten Tags</strong>, die jeweilige
                        ...
                        {/* Footer */}
                        <IDInfoBoxFooter id={id} view={ShowView.COLORS} handleChangeView={handleChangeView}>
